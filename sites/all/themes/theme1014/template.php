...
/**
 * @file
 * Contains theme override functions and process & preprocess functions for theme1014
 */

// Auto-rebuild the theme registry during theme development.
if ( theme_get_setting( 'theme1014_clear_registry' ) ) {
	// Rebuild .info data.
 ...
 */
function theme1014_html_head_alter( &$head_elements ) {
 ...
 */
function theme1014_preprocess_search_block_form( &$vars ) {
 ...
 */
function theme1014_preprocess_html( &$vars ) {
	$vars['doctype'] = _theme1014_doctype();
	$vars['rdf'] = _theme1014_rdf( $vars );
	...
	if ( !$vars['is_front'] ) {
		...
		if ( isset( $page_name ) ) {
			$vars['classes_array'][] = theme1014_id_safe( 'page-' . $page_name );
		}

		$vars['classes_array'][] = theme1014_id_safe( 'section-' . $section );
	...
	if ( ( $d['destination'] == 'blog' ) && ( theme_get_setting( 'theme1014_blog_title' ) != "" ) ) {
		$vars['title'] = theme_get_setting( 'theme1014_blog_title' );
		$vars['head_title'] = theme_get_setting( 'theme1014_blog_title' );
	}
}
 ...
 */
function theme1014_preprocess_page( &$vars ) {
 ...
 */
function theme1014_preprocess_maintenance_page( &$vars ) {
	...
	drupal_add_css( drupal_get_path( 'theme', 'theme1014' ) . '/css/maintenance-page.css' );
}
 ...
 */
function theme1014_preprocess_node( &$vars ) {
	// Striping class
 ...
 */
function theme1014_preprocess_block( &$vars, $hook ) {
 ...
 */
function theme1014_menu_tree( $vars ) {
 ...
 */
function theme1014_field__taxonomy_term_reference( $vars ) {
	$output = '';
 ...
 */
function theme1014_breadcrumb( $vars ) {
	$breadcrumb = isset( $vars['breadcrumb'] ) ? $vars['breadcrumb'] : array();

	$condition = theme_get_setting( 'theme1014_breadcrumb_hideonlyfront' ) ? count( $breadcrumb ) > 1
			: !empty( $breadcrumb );
	$separator = theme_get_setting( 'theme1014_breadcrumb_separator' );

	if ( theme_get_setting( 'theme1014_breadcrumb_showtitle' ) ) {
 ...
 * @return bool
 */
function theme1014_tabs_float() {
	$float = (bool) theme_get_setting( 'theme1014_tabs_float' );
	$float_node = (bool) theme_get_setting( 'theme1014_tabs_node' );
...
function theme1014_id_safe( $string ) {
	// Strip accents
 ...
 * @ingroup themeable
 */
function theme1014_menu_link( array $vars ) {
	...
	$element['#attributes']['class'][] = theme1014_id_safe( $element['#title'] );
 ...
 */
function theme1014_preprocess_menu_local_task( &$vars ) {
 ...
 */
function theme1014_menu_local_tasks( &$vars ) {
	$output = '';
 ...
 */
function theme1014_preprocess_comment( &$variables ) {
...
/* Region options */
function theme1014_region_preffix ( $reg ) {
	$block_bg_type = theme_get_setting( 'theme1014_' . $reg . '_bg_type' );
	$block_bg_img = theme_get_setting( 'theme1014_' . $reg . '_bg_img' );
	$block_bg_parallax = theme_get_setting( 'theme1014_' . $reg . '_bg_parallax' );
	$bg_video = theme_get_setting( 'theme1014_' . $reg . '_bg_video' );
	$bg_video_start = theme_get_setting( 'theme1014_' . $reg . '_bg_video_start' );
	$fullwidth = theme_get_setting( 'theme1014_' . $reg . '_fullwidth' );
...
function theme1014_region_suffix ( $reg ) {
	$fullwidth = theme_get_setting( 'theme1014_' . $reg . '_fullwidth' );
	$block_bg_parallax = theme_get_setting( 'theme1014_' . $reg . '_bg_parallax' );
	$block_bg_img = theme_get_setting( 'theme1014_' . $reg . '_bg_img' );
...
function theme1014_form_contact_site_form_alter( &$form, &$form_state, $form_id ) {
