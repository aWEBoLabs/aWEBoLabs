...
<?php if ( !theme_get_setting( 'theme1014_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme1014_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1"> <!-- Sticky menu wrapper -->
				<div class="container-12">
					<div class="grid-12">
						<div class="col1">
							<!-- Logo -->
			...
			<!-- Region Header -->
			<?php if ( $page['header'] ) : 
				theme1014_region_preffix ( 'header' );
					print render( $page['header'] );
				theme1014_region_suffix ( 'header' );
			endif; ?>

			<!-- Region Header bottom -->
			<?php if ( $page['header_bottom'] ) : 
				theme1014_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme1014_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['section_1'] ) : 
				theme1014_region_preffix ( 'section_1' );
					print render( $page['section_1'] );
				theme1014_region_suffix ( 'section_1' );
			endif; ?>
			
			<!-- Region Section 2 -->
			<?php if ( $page['section_2'] ) : 
				theme1014_region_preffix ( 'section_2' );
					print render( $page['section_2'] );
				theme1014_region_suffix ( 'section_2' );
			endif; ?>
			
			<!-- Region Section 3 -->
			<?php if ( $page['section_3'] ) : 
				theme1014_region_preffix ( 'section_3' );
					print render( $page['section_3'] );
				theme1014_region_suffix ( 'section_3' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			<div class="footer-wrapper">
				...
				<?php if ( $page['footer_top'] ) : 
					theme1014_region_preffix ( 'footer_top' );
						print render( $page['footer_top'] );
					theme1014_region_suffix ( 'footer_top' );
				endif; ?>
				<div class="container-12">
					<div class="grid-12 clearfix">
						...
						<?php if ( $is_front ) : ?>
							More Software Company Drupal Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/software-company-drupal-themes/" target="_blank">TemplateMonster.com</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
